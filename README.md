...
Version **0.1.0** · **15 specialist stages** · **5 routes** · Python **3.10+ target** · **Human review**
...
|---|---:|---|
| `sovereign-bond` | 15 | bond |
| `sovereign-social-bond` | 15 | bond |
| `debt-for-development-swap` | 15 | bond, bilateral_program |
| `blended-finance` | 15 | bond, private_project |
| `outcome-finance` | 15 | outcome_contract, bond |
...
```bash
python3 -m sf_agent calc --operation swap_value --arguments examples/calculation-arguments.json --currency USD
```
